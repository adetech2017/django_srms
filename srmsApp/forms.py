...
class SaveResult(forms.ModelForm):
    ...
    session = forms.CharField(max_length="250", label="session")
...
class SaveSubjectResult(forms.ModelForm):
    ...
    test_score = forms.CharField(max_length="100", label="Test Score")
    exam_score = forms.CharField(max_length="100", label="Test Score")
    total_score = forms.CharField(max_length="100", label="Total Score")
    
    
    class Meta:
        model = models.Student_Subject_Result
        fields = ('result','subject','test_score', 'exam_score', 'total_score')
